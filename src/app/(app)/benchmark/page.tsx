export const metadata = { title: 'Benchmark — WARD' }
...
export default function BenchmarkPage() {
  return (
    <div>
      ...
      <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 28, fontWeight: 400, letterSpacing: '0.04em', color: 'var(--text)', margin: 0, lineHeight: 1 }}>Benchmark</h1>
      <p style={{ color: 'var(--text-4)', fontSize: 11, marginTop: 8, fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
        Módulo em desenvolvimento · Fase 5 do roadmap
      </p>
    </div>
  )
}
